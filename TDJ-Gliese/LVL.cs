            ...
            foreach (EnemyShip E in Wave3)
            {
                if (E.ShootTimer == 0)
                {
                    ...
                    if (E.isboss == true)
                    {
                        ...
                        EnemyProjectile2.ProjectileDamage = 50;
            ...
            foreach (EnemyShip E in Wave4)
            {
                if (E.ShootTimer == 0)
                {
                    ...
                    if (E.isboss == true)
                    {
                        ...
                        EnemyProjectile.ProjectileDamage = 75;
                        EnemyProjectile2.ProjectileDamage = 75;
                        ...
                        EnemyProjectile.ShootSpeed = 9;
                        EnemyProjectile2.ShootSpeed = 9;
